...
В главном окне отображается итоговый вес и площадь окраски.

### Обновления:
1. Добавлена возможность редактирования элемента металлоконструкции
2. Добавлена возможность сохранения и загрузки проектов
3. Улучшения интерфейса
4. Мелкие доработки и исправления
